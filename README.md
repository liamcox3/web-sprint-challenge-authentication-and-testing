...
json tokens have a cryptographic signature and session cookies do not but one of the big important things is that session and cookies take up memory where as json tokens are stateless making tokens more scalable.

2. What does `bcrypt` do to help us store passwords in a secure manner.

It hashes them making it harder for hackers.

3. How are unit tests different from integration and end-to-end testing.

unit test will test isolated units in the code such as functions and features etc, where as integration test will test how the application interacts with each other mostly focusing on testing endpoints in a code base.

4. How _Test Driven Development_ changes the way we write applications and tests.

Its an approach of writing the code to fix any failed tests first before writing any new code. This is to ensure quality code that isnt going to break once shipped to production.
